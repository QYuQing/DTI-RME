...
dataname = 'e';
cv_type = 'CVD';
[y,~,~] = loadtabfile(['D:/KronRLS/IDTI-MK-TCMF-main/data/interactions/' dataname '_admat_dgc.txt']);
...
for fold=1:nfolds
    ...
    zero_index = zero_index(1:5*num_ones);
    test_idx = [test_idx(ones_index);test_idx(zero_index)];
    %% kernel
    k1_paths = {['D:/KronRLS/IDTI-MK-TCMF-main/data/kernels/' dataname '_simmat_proteins_sw-n.txt'],...
        ['D:/KronRLS/IDTI-MK-TCMF-main/data/kernels/' dataname '_simmat_proteins_go.txt'],...
        ['D:/KronRLS/IDTI-MK-TCMF-main/data/kernels/' dataname '_simmat_proteins_ppi.txt'],...
        };
    K1 = [];
...
%     K1(:,:,3+3) = Knormalized( kernel_corr(y_train,1,MU,GAMMA) );
    k2_paths = {['D:/KronRLS/IDTI-MK-TCMF-main/data/kernels/' dataname '_simmat_drugs_simcomp.txt'],...
        ['D:/KronRLS/IDTI-MK-TCMF-main/data/kernels/' dataname '_simmat_drugs_sider.txt'],...
        };
    K2 = [];
    ...
    gamma_fp = 4;
    load(['D:/KronRLS/IDTI-MK-TCMF-main/data/kernels/' dataname '_Drug_MACCS_fingerprint.mat']);
...
%     K2(:,:,3+3) = Knormalized( kernel_corr(y_train,2,MU,GAMMA) );
    ...
    sparse = 100;
    maxiter = 2;
    [pre] = DTI_RME(K1,K2,y_train,sita,alpha,lambda,regcoef,r,sparse);
